...
from windows_native import NativeTextController
from windows_thread_identity import unique_empty_thread_name, recent_assignment_matches
...
class EmptyThreadIdentityTest(unittest.TestCase):
    ...
    def test_api_errors_duplicates_and_incomplete_scans_cannot_fallback(self):
        ...
        with patch('windows_native.unique_empty_thread_name', return_value=True) as local:

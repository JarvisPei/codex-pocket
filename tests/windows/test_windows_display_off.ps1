...
Add-Type -Path (Join-Path $PSScriptRoot '..\..\platforms\windows\scripts\windows-display-state.cs') -ReferencedAssemblies System.Windows.Forms
$source=Get-Content -Raw -LiteralPath (Join-Path $PSScriptRoot '..\..\platforms\windows\scripts\windows-desktop-send.ps1')

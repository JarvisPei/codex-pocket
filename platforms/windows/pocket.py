...
def run_runtime(binary, *, taskbar=False, stream=None, emit=None):
    from platforms.windows.bridge import make_server, windows_token, state_directory, open_first_install_pairing
    from platforms.windows.desktop_helper import serve, safe_entry

...
from platforms.windows.delivery import DeliveryJournal, UUID, user_receipts, validate_delivery
from platforms.windows.thread_identity import unique_empty_thread_name
    ...
    def do_POST(self):
        ...
        if (creating or (target and parts[-1] == 'turn')) and payload.get('attachmentIds'):
            ...
            try:
                ...
                if creating:
                    from platforms.windows.create import creation_input
